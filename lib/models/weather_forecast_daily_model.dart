...
part 'weather_forecast_daily_model.g.dart';

@JsonSerializable()
class WeatherForecastM {
  City? city;
  String? cod;
  double? message;
  int? cnt;
  ...
  WeatherForecastM({this.city, this.cod, this.message, this.cnt, this.list});

  factory WeatherForecastM.fromJson(Map<String, dynamic> json) =>
